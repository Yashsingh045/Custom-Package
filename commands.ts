...
class ApiCommands {
  ...
  public async joke(): Promise<void> {
    try {
  ...
  public async quote(): Promise<void> {
    try {
  ...
  public async info(country: string): Promise<void> {
    try {
  ...
  public async weather(city: string): Promise<void> {
    try {
  ...
  public async pokemon(name: string): Promise<void> {
    try {
...
export class CLICommands {
  ...
  private mathCommands = new MathCommands()
  private apiCommands = new ApiCommands()
